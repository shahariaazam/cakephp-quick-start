...
<div class="form-group">
    <label for="username" class="col-lg-2 control-label">Existing Password</label>
    <div class="col-lg-4">
        <?php echo $this->Form->input('newpassword', array('type'=> 'password', 'div'=>false, 'label'=>false, 'class'=>'form-control'));?>
    </div>
</div>
<div class="form-group">
    <label for="username" class="col-lg-2 control-label">Existing Password</label>
    <div class="col-lg-4">
        <?php echo $this->Form->input('renewpassword', array('type'=> 'password', 'div'=>false, 'label'=>false, 'class'=>'form-control'));?>
    </div>
</div>
<div class="form-group">
